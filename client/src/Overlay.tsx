...
const Overlay = () => {
    ...
    return (
        <Box position="fixed" top={0} left={0} color="white" textAlign={"center"} width="100%" height={"100%"} display={"flex"} flexDirection={"column"} justifyContent={"center"} overflow={"hidden"}>
            <Stack display="flex" flexDirection="column" alignItems="center" gap={5}>
                <Box bg="rgba(0,0,0,0.5)" height={bgHeight} width={"100%"} textAlign={"center"} justifyContent={"center"} display={"flex"} alignItems={"center"}>
